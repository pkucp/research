...
%                                     end
                                    ...
                                    F222=[0<=BP22(1)<=B2_0,0<=BP22(2)<=P3_0,cap(BP22(1),BP22(2),...
                                        d12_R(relayi,relayj),ga(gasel),N0)<=cap(BP22(1),x(3,k,relayi,relayj),...
                                        d23_V(eachcari,eachcarj),ga(gasel),N0),cap(BP22(1),x(3,k,relayi,relayj),...
                                        d23_V(eachcari,eachcarj),ga(gasel),N0)<=2*c0];
                                    F223=[0<=BP23(1)<=B2_0,0<=BP23(2)<=P3_0,cap(BP23(1),x(3,k,relayi,relayj),...
                                        d23_V(eachcari,eachcarj),ga(gasel),N0)<=cap(BP23(1),BP23(2),d12_R(relayi,...
                                        relayj),ga(gasel),N0),cap(BP23(1),BP23(2),d12_R(relayi,relayj),ga(gasel),N0)<=2*c0];
                                    F211=[0<=BP21(1)<=B2_0,0<=BP21(2)<=P3_0,min(cap(BP21(1),BP21(2),...
                                        d12_R(relayi,relayj),ga(gasel),N0),cap(BP21(1),x(3,k-1,relayi,relayj),...
                                        d23_V(eachcari,eachcarj),ga(gasel),N0))>=2*c0];
                                    F212=[0<=BP22(1)<=B2_0,0<=BP22(2)<=P3_0,cap(BP22(1),BP22(2),...
                                        d12_R(relayi,relayj),ga(gasel),N0)<=cap(BP22(1),x(3,k-1,relayi,relayj),...
                                        d23_V(eachcari,eachcarj),ga(gasel),N0),cap(BP22(1),x(3,k-1,relayi,relayj),...
                                        d23_V(eachcari,eachcarj),ga(gasel),N0)<=2*c0];
                                    F213=[0<=BP23(1)<=B2_0,0<=BP23(2)<=P3_0,cap(BP23(1),x(3,k-1,relayi,relayj),...
                                        d23_V(eachcari,eachcarj),ga(gasel),N0)<=cap(BP23(1),BP23(2),...
                                        d12_R(relayi,relayj),ga(gasel),N0),cap(BP23(1),BP23(2),d12_R(relayi,relayj),...
                                        ga(gasel),N0)<=2*c0];
